...
{	
	override void Init()
	{
		...
		//result1
		AddResult("FilledCasing545x39");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(24 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
