class Craft22LRFilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill 22LR Casing";
		...
		//result1
		AddResult("FilledCasing22LR");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(6 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
