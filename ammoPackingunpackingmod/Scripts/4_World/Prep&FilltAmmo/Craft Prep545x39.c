class Craft545x39prep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Prepare 545x39 ammo";
		...
		//ingredient 2
		InsertIngredient(1,"FilledCasing545x39");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Prep545x39");//add results here
