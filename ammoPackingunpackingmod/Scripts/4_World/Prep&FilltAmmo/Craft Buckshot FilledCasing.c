class CraftBuckshotFilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill Crafted Shotgun Shell";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CasingCraftedShotgunShells");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"Gunpowder");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FilledCraftedShotgunShell");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(40 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());		// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
