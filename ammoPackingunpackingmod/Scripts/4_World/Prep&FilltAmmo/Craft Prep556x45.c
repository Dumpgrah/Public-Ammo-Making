class Craft556x45prep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Prepare 556x45 ammo";
		...
		//ingredient 2
		InsertIngredient(1,"FilledCasing556x45");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Prep556x45");//add results here
