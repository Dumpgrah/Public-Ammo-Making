class Craft762x39prep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Prepare 762x39 ammo";
		...
		//ingredient 2
		InsertIngredient(1,"FilledCasing762x39");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Prep762x39");//add results here
