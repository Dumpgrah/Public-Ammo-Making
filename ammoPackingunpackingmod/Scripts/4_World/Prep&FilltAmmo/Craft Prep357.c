class Craft357prep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Prepare .357 Magnum ammo";
		...
		//ingredient 2
		InsertIngredient(1,"FilledCasing357");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Prep357Magnum");//add results here
