class CraftRubberTip9 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut out 9x19 Rubber Tips";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"ScrapRubber");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TipsRubber9X19");//add results here
...
class CraftRubberTip45 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut out 45ACP Rubber Tips";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("TipsRubber45ACP");//add results here
...
class CraftRubberTip380 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut out 380ACP Rubber Tips";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("TipsRubber380ACP");//add results here
...
class CraftRubberTip762x54 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut out 762x54 Rubber Tips";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("Tips762x54Rubber");//add results here
