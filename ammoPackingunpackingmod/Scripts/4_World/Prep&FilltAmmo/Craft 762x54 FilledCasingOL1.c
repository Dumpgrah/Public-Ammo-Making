class Craft762x54OLFilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill 762x54 Overloaded Casing";
		...
		//result1
		AddResult("FilledCasing762x54OP");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(58 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
