class Craft357FilledCasings extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill .357 Magnum Casing";
		...
		//result1
		AddResult("FilledCasing357");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(13 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
