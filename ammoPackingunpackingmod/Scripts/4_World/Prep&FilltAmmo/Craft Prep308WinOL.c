class CraftPrep308WinOLprep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Prepare 308Win overloaded ammo";
		...
		//ingredient 2
		InsertIngredient(1,"FilledCasing308WinOL");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Prep308WinOL");//add results here
