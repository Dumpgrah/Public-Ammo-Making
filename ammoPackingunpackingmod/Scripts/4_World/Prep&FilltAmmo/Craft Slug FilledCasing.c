class CraftSlugFilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill Slug Casing";
		...
		//result1
		AddResult("FilledCasingSlug");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(33.7 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());
	int itemone
	int itemtwo
