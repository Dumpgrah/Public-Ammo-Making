class CraftBuckshotprep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Prepare Buckshot ammo";
		...
		//ingredient 2
		InsertIngredient(1,"FilledCraftedShotgunShell");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("PrepBuckshot");//add results here
