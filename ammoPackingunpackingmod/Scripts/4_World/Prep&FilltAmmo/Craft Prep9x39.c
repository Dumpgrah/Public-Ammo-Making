class Craft9x39prep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Prepare 9x39 ammo";
		...
		//ingredient 2
		InsertIngredient(1,"FilledCasing9x39");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Prep9x39");//add results here
