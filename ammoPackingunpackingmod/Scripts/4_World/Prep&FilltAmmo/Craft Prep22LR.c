class Craft22LRprep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Prepare 22LR ammo";
		...
		//ingredient 2
		InsertIngredient(1,"FilledCasing22LR");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Prep22LR");//add results here
