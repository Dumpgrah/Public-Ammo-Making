class Craft45ACPFilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill 45ACP Casing";
		...
		//result1
		AddResult("FilledCasing45ACP");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(11 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
