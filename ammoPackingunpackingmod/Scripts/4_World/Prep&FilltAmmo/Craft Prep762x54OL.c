class Craft762x54OLprep extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Prepare 762x54 Overloaded ammo";
		...
		//ingredient 2
		InsertIngredient(1,"FilledCasing762x54OP");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Prep762x54OP");//add results here
