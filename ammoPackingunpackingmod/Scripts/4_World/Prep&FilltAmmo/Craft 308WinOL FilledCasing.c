class Craft308WinOLFilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Over fill 308Win Casing";
		...
		//result1
		AddResult("FilledCasing308WinOL");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(68 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
