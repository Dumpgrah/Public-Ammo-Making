class Craft762x39FilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill 762x39 Casing";
		...
		//result1
		AddResult("FilledCasing762x39");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(25 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
