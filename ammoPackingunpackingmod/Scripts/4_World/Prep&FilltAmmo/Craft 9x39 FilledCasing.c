class Craft9x39FilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill 9x39 Casing";
		...
		//result1
		AddResult("FilledCasing9x39");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(12 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
