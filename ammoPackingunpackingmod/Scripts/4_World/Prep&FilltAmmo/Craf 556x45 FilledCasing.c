class Craft556x45FilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill 556x45 Casing";
		...
		//result1
		AddResult("FilledCasing556x45");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(22 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
