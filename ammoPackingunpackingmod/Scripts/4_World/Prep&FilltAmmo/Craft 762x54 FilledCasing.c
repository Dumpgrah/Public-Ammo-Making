class Craft762x54FilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill 762x54 Casing";
		...
		//result1
		AddResult("FilledCasing762x54");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(51 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
