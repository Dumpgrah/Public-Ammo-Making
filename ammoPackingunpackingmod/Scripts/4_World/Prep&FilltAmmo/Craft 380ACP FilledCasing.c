class Craft380ACPFilledCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill 380ACP Casing";
		...
		//result1
		AddResult("FilledCasing380ACP");//add results here
	...
	int ItemTwoRequirement = Math.Ceil(5 * GetAmmoBuildingSettings().GetPercentageValueGunpowderRequired());				// Add here the requirement to craft ONE item
	int itemone
	int itemtwo
