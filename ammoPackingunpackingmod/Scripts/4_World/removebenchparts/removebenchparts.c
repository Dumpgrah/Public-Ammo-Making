class RemoveScale extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove scale";
		...
		m_IngredientAddHealth[0] = -280;// 0 = do nothing
		...
		//result1
		AddResult("Scale");//add results here
...
class RemoveScale2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove scale";
...
class RemoveScale3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove scale";
...
class RemoveScale4 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove scale";
...
class Removefunnel extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove funnel";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("Funnel");//add results here
...
class Removefunnel2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove funnel";
...
class Removefunnel3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove funnel";
...
class Removefunnel4 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove funnel";
...
class RemovePress extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove press";
...
class RemovePress2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove press";
...
class RemovePress3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove press";
...
class RemovePress4 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Remove press";
